                                                       ...
                                                       CElementwiseOperation>
{
    ...
    struct Invoker : public BaseInvoker
    {
        ...
        float Run(const Argument& karg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            // Warm-up phase: Run the kernel 5 times
            for (int i = 0; i < 5; ++i)
            {
            ...
            // Average time calculation over 10 iterations
            float total_time = 0;
            for (int i = 0; i < 10; ++i)
            {
                float time = launch_and_time_kernel(stream_config,
                                                    kernel,
                                                    grid_dims,
                                                    dim3(BlockSize),
                                                    0,
            ...
            return total_time / 10;  // Return the average execution time
        }
